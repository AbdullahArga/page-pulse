<script setup>
import logo from '@images/main-logo.svg?raw'
...
const { loginForm, submitLogin, validationError } = authService()
</script>
  ...
  <div class="auth-wrapper d-flex align-center justify-center pa-4">
    ...
    >
      ...
      <VCardText class="pt-2">
        <h5 class="text-h5 font-weight-semibold mb-1">Welcome to Page Pulse! 👋🏻</h5>
